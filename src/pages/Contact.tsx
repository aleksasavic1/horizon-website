...
const Contact = () => {
  ...
  return (
    ...
    >
      ...
      >
        If you enjoyed this project and would like to collaborate, have any
        questions, or just want to share your thoughts, feel free to reach out!
        I'm always open to new opportunities and discussions. Looking forward to
        hearing from you!
      </Typography>
